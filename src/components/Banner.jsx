    ...
    return (
        <div>
            <section className="px-4">
                <div
                    className="bg-gradient-to-br from-[#845984] via-[#974c7e] to-[#c04195] p-6 sm:p-10 rounded-2xl w-full text-white flex items-center justify-between  mx-auto my-4">
                    ...
                    <div>
                        <svg className="w-20 h-20 text-gray-100" viewBox="0 0 15 15">
                            <path fill="currentColor"
