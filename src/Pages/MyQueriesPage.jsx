...
const MyQueriesPage = () => {
    ...
    useEffect(() => {
        fetch(`https://b9a11-server-side-sakhawat-code-info.vercel.app/myQueries/${user.email}`)
            .then(res => res.json())
            .then(data => {
    ...
    const handleDelete = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`https://b9a11-server-side-sakhawat-code-info.vercel.app/queryDelete/${id}`, {
                    method: "DELETE"
                })
                    .then(res => res.json())
                    .then(data => {
        ...
        <div>
            ...
            <div className="">
                <div className="mx-auto max-w-7xl my-6 px-2 sm:px-6 lg:px-8">
                    <div className="rounded-lg bg-[#0a3d62] p-2 shadow-lg sm:p-3">
                        <div className="flex flex-wrap items-center justify-between">
                            <div className="flex w-0 flex-1 items-center">
                                <span className="flex rounded-lg bg-indigo-800 p-2">
                                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="h-6 w-6 text-white"><path d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"></path></svg>
                                </span>
