        ...
        <div className="py-16">
            <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                <div className="w-full p-8 lg:w-1/2">
                    ...
                    <a onClick={handleGoogleLogin} className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                        ...
                        <Link to={'/register'} className="text-xs text-gray-500 uppercase">or
                            <span className="link link-primary"> registration</span> </Link>
                        <span className="border-b w-1/5 md:w-1/4"></span>
                    </div>
                </div>
            </div>
