...
const UpdateQueriesPage = () => {
    ...
    const handleUpdateQueries = (e) => {
        ...
        fetch(`https://b9a11-server-side-sakhawat-code-info.vercel.app/updateAddQueryData/${_id}`, {
            method: "PUT",
            headers: {
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-6 gap-6">
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="photo.jpj" name="productImageURL" defaultValue={productImageURL} required />
                            </div>
                            <div className="col-span-6 sm:col-span-3">
                                <label className="text-sm font-medium text-gray-900 block mb-2">Query Title</label>
                                <input type="text" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Query TItle" name="queryTitle" defaultValue={queryTitle} required />
                            </div>
                            ...
                            <div className="col-span-full">
                                ...
                                <textarea id="product-details" rows="6" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4" name="boycottingReasonDetails" defaultValue={boycottingReasonDetails} placeholder="Details" required ></textarea>
                            </div>
                        </div>
...
export default UpdateQueriesPage; 