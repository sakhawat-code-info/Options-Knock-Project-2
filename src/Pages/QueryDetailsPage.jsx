                ...
                <div className=" gap-10">
                    ...
                    <div className="max-w-xl mx-auto mt-10">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-2 text-right font-extrabold">Date Posted 12.12.2212</p>
                            <h2 className="text-2xl font-extrabold text-gray-800">Query Title Dark s with white laces</h2>
                            <p className="text-sm text-gray-600 mt-2 font-extrabold">Product Name</p>
                        </div>
                        ...
                        <div className="flex space-x-1 mt-4">
                            ...
                            <button type="button" className="px-2.5 py-1.5 bg-gray-100 text-xs text-gray-800 rounded-md flex items-center !ml-4">
                                ...
                                87 Reviews recommendationCount
                            </button>
                        </div>

                        <div className="mt-4">
                            <h3 className="text-gray-800 text-3xl font-bold">Brand Name</h3>
                        </div>
                        ...
                        <div className="mt-8">
                            <ul className="flex border-b">
                                <li
                                    ...
                                    Alternation Reason</li>
                            </ul>

                            <div className="mt-8">
                                <p className="text-sm text-gray-600 mt-4">Step up your footwear game with our premium menshoes. Designed for comfort and crafted with a contemporary aesthetic, these versatile shoes are a must-have addition to your wardrobe. The supple and breathable materials ensure all-day comfort, making them perfect for everyday wear.</p>
                            </div>
                        ...
                        <div className="flex items-center mt-8">
                            ...
                            <div className="ml-3">
                                ...
                                <h4 className="text-sm font-semibold">sakhawat.4hossen@gmail.com</h4>
                                <h4 className="text-sm font-semibold">20/12/12</h4>
                            </div>
                        </div>
